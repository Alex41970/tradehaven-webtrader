-- Add comprehensive collection of popular trading assets (conflict-safe)
...
('BNBUSD', 'Binance Coin', 'crypto', 635.42, 1.2, 0.01, 50, 0.02, 1, 'BNB', 'USD'),
('SOLUSD', 'Solana', 'crypto', 145.82, 2.8, 0.01, 50, 0.02, 1, 'SOL', 'USD'),
('LINKUSD', 'Chainlink', 'crypto', 14.25, -0.9, 0.1, 50, 0.01, 1, 'LINK', 'USD'),
...
('INTC', 'Intel Corporation', 'stocks', 23.45, -1.8, 0.01, 10, 0.02, 1, 'INTC', 'USD'),
('AMD', 'Advanced Micro Devices', 'stocks', 142.67, 3.2, 0.01, 10, 0.02, 1, 'AMD', 'USD'),
...
('GS', 'Goldman Sachs', 'stocks', 485.73, 1.4, 0.01, 10, 0.02, 1, 'GS', 'USD'),
...
('NKE', 'Nike Inc', 'stocks', 98.25, 1.8, 0.01, 10, 0.02, 1, 'NKE', 'USD'),
...
('USDDKK', 'US Dollar / Danish Krone', 'forex', 6.8942, 0.1, 1000, 200, 3, 100000, 'USD', 'DKK'),
('USDPLN', 'US Dollar / Polish Zloty', 'forex', 3.9245, -0.3, 1000, 200, 4, 100000, 'USD', 'PLN'),
...
('EURJPY', 'Euro / Japanese Yen', 'forex', 164.523, 0.8, 1000, 200, 2, 100000, 'EUR', 'JPY'),
('GBPJPY', 'British Pound / Japanese Yen', 'forex', 193.245, 1.2, 1000, 200, 3, 100000, 'GBP', 'JPY'),
...
('AUS200', 'ASX 200', 'indices', 7845.32, 0.6, 0.1, 100, 2, 10, 'AUS200', 'AUD'),
('JPN225', 'Nikkei 225', 'indices', 39420.87, 1.4, 0.1, 100, 3, 10, 'JPN225', 'JPY'),
...
('COCOA', 'Cocoa', 'commodities', 3850.25, 2.8, 1, 50, 10, 10, 'COCOA', 'USD'),
...
('PLATINUM', 'Platinum', 'commodities', 985.42, 0.8, 0.1, 50, 2, 50, 'PLATINUM', 'USD'),
('PALLADIUM', 'Palladium', 'commodities', 1245.85, -1.2, 0.1, 50, 5, 100, 'PALLADIUM', 'USD'),
